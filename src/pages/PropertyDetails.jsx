    ...
    return (
        <main className="min-h-screen  pb-20">
            <header className="py-3">
                ...
                <h1 className="text-lg text-[#10002B] my-6 md:text-2xl">Visualize e confirme o cadastro do seu imóvel</h1>
            </header>
            ...
            <div className="px-4">
                ...
                <div className="py-4 flex items-center justify-center ">
                    <button className="p-2 px-32 text-white bg-[#7B2CBF] hover:bg-purple-700 flex justify-center items-center rounded-lg">
                        <Video className="mr-2 h-5 w-5" /> Vídeo Visita
                    </button>
                </div>
                ...
                <div className="flex items-center gap-3 mt-6 py-4 border-b border-t">
                    <span className="text-lg font-bold text-black">Locado por Henrique Rodrigues</span>
                    <img src="avatar.png" alt="Locador" className="w-8 h-8 rounded-full" />
                </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {["Guarda-roupa", "Frigobar", "Cama de casal", "Bidê", "Box blindex", 
                          ...
                          "Sofá cama", "Televisão"].map((item, index) => (
                            <div key={index} className="text-sm text-gray-600 bg-gray-100 rounded-full px-3 py-1">
                                {item}
                            </div>
                        ))}
                    </div>
                ...
                <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg mt-8 ">
